 ...
 * 
 * Following TOON specification, arrays can use different delimiters
 ...
 * 
 * @param char The character used for delimiting
 * @param symbol The symbol used in array headers
 */
