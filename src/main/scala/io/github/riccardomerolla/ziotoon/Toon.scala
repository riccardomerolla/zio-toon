 ...
 * following ZIO best practices for effect-oriented programming.
 * 
 * ==Overview==
 * 
...
object Toon {
   ...
   * 
   * This is a pure method that directly executes encoding without side effects.
   * Use this when you don't need dependency injection or effect composition.
   * 
   * @param value The ToonValue to encode
   * @param config The encoder configuration (default: EncoderConfig.default)
   * @return The TOON format string
   * 
   * @example
   * {{{
   ...
   * Returns Either with typed errors in the Left channel.
   * 
   * @param input The TOON format string to decode
   * @param config The decoder configuration (default: DecoderConfig.default)
   * @return Either ToonError or ToonValue
   * 
   * @example
   * {{{
   ...
   * 
   * @param value The ToonValue to round-trip
   * @return A ZIO effect that either fails with ToonError or succeeds with decoded ToonValue
   * 
   * @example
   * {{{
   ...
   * 
   * Use this when you need non-default encoding/decoding behavior.
   * Configuration is provided at layer construction time.
   * 
   * @param encoderConfig Custom encoder configuration
   * @param decoderConfig Custom decoder configuration
   * @return A layer providing configured encoder and decoder services
   * 
   * @example
   * {{{
   * val customLayer = Toon.configured(
