...
3. **Monitor the release**:
   - Go to Actions tab in GitHub: https://github.com/riccardomerolla/zio-toon/actions
...
4. **Verify publication** (10-30 minutes after release):
   - Check Maven Central: https://search.maven.org/search?q=g:io.github.riccardomerolla%20AND%20a:zio-toon*
   - Check GitHub Releases: https://github.com/riccardomerolla/zio-toon/releases
